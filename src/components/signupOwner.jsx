    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#f9fafb] px-4 py-8">
            <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 md:p-10 flex flex-col items-center mx-auto">
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Sign Up as an Owner</h2>
                ...
                <p className="mt-4 text-sm text-center text-gray-600">
                    Want to sign up as a customer? <Link to="/signup/customer" className="text-[#6366f1] underline">Sign up as a customer</Link>
                </p>
            </div>
        </div>
    )
